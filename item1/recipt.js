    ...
    if(this.readyState == 4 && this.status == 200){
        ...
        var key = window.prompt("Enter pin number");
            let obj =jsonObject.find(pin =>pin.pinnumber === key)
                ...
                var amu = document.getElementById("fp").innerHTML=obj.amount;
                var amu = document.getElementById("sp").innerHTML=obj.amount;
                var amu = document.getElementById("tp").innerHTML=obj.amount;
